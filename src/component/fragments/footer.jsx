    ...
    return(
        <div className="w-full  bg-primary dark:bg-primary mt-10 ">
            <div className="container mx-auto py-4 px-4">
                ...
                <p className="text-sm text-white mb-6">Smart Financial Tracker membantu Anda mencatat transaksi,<br /> menganalisis pola keuangan, dan memprediksi keuangan dengan Al. Aman, mudah, dan otomatis! </p>
                <div className="container-2 flex flex-col lg:flex-row justify-between">
                    <div className="contact flex flex-col">
                        ...
                        <div className="flex items-center mb-6 gap-2 lg:ml-10">
                            ...
                            <p className="text-md text-white">aleganteng@gmail.com</p>
                        </div>
                        <div className="flex items-center mb-6 gap-2 lg:ml-10">
                            <img src="/img/corner-down-right.svg" alt="" className="w-[25px]"/>
                            <div className="bg-white/10 p-2 rounded-full">
                            ...
                            <p className="text-md  text-white">banyorep</p>
                        </div>
                        <div className="flex items-center mb-6 gap-2 lg:ml-10">
                            <img src="/img/corner-down-right.svg" alt="" className="w-[25px]"/>
                            <div className="bg-white/10 p-2 rounded-full">
                ...
                <div >
                    ...
                    <div className="flex justify-center items-center">
                        <p className="text-md  text-white">Copyright 1945 Financial Tracker. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
