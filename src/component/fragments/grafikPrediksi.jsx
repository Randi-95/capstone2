    ...
    <div>
      {isLoading ? (
        ...
        <p className="font-medium text-sm">
         Gagal Memprediksi Data Keuangan
        </p>
        <button
      ...
      <ResponsiveContainer  height={300}>
        <LineChart data={dataKeuangan}>
          ...
          <Line type="monotone" dataKey="Batas Atas" stroke="#4ade80" strokeWidth={2} dot={{ stroke: '#4ade80', strokeWidth: 2 }} />
          <Line type="monotone" dataKey="Batas Bawah" stroke="#f87171" strokeWidth={2} dot={{ stroke: '#f87171', strokeWidth: 2 }} />
        </LineChart>
      </ResponsiveContainer>

      <h2 className="text-center mt-6 text-gray-800 dark:text-white font-medium text-lg">
        Prediksi Saldo: <span className="text-blue-500 dark:text-blue-400 font-semibold">Rp {saldoAkhir.toLocaleString("id-ID")}</span>
      </h2>      
        </>
      )}
    </div>
