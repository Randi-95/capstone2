      ...
      <div>
        ...
        <div className="flex flex-wrap p-6 gap-4 justify-center">
          {articles.map((article) => (
            <div
              key={article.id}
              className="card shadow-lg flex flex-col w-[350px] h-[550px] border-solid border-[1.5px] border-gray-200 rounded-2xl p-6"
            >
              ...
              <div className="content flex flex-col flex-grow">
                <div className="tag mb-3">
                  <h1 className="bg-gray-100 rounded-3xl inline px-4 py-2 text-primary font-medium">
                    Financial
                  </h1>
                </div>
                
                <div className="deskripsi flex flex-col flex-grow">
                  <h1 className="text-xl font-semibold md:text-2xl mb-2 line-clamp-2">
                    {article.title}
                  </h1>
                  <p className="line-clamp-4 text-sm">{article.summary}</p>
                </div>
              </div>
              
              <div className="container-button flex justify-center mt-4">
                <button 
                  className="border-solid border-[1.5px] border-gray-200 w-full text-center px-3 py-3 rounded-full hover:bg-gray-50 transition"
    ...
    <div className="flex flex-col justify-center">
      ...
      <div className="container flex flex-col px-8 md:px-[200px] m-auto justify-center items-center max-w-4xl">
        ...
        <div className="container-isi w-full">
          <h1 className='text-2xl text-left md:text-4xl font-bold text-primary dark:text-white my-6'><span className='text-[#374151]'>Judul : </span> {articleActive.title}</h1>
          <p className="text-justify">{articleActive.content}</p>
        </div>
        <button 
          className="mt-8 mb-12 border-solid border-[1.5px] border-gray-200 px-6 py-3 rounded-full hover:bg-gray-50 transition"
