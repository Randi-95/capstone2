    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="container mx-auto max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6 text-center">
          ...
          <p className="text-3xl font-bold text-primary">Rp 2.000.000</p>
          ...
          <div className="flex justify-between mt-4 space-x-4">
            <div className="bg-green-100 rounded-lg p-3 flex-1 text-center">
              ...
              <p className="text-xl font-bold text-green-900">Rp 1.000.000</p>
            </div>
            <div className="bg-red-100 rounded-lg p-3 flex-1 text-center">
              <p className="text-red-700 font-semibold">Pengeluaran</p>
              <p className="text-xl font-bold text-red-900">Rp 100.000</p>
            </div>
          </div>
        </div>
