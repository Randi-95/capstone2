    ...
    return (
        <div className="home w-full h-screen flex flex-col items-center justify-center">
            ...
            <div className="content flex flex-col justify-center ">
                <p className="lg:text-[60px] md:text-[50px] text-[30px] sm:text-[40px] leading-[40px] md:leading-[65px]  text-center  font-[600] text-[#374151]"><span className="text-[#7f5efd]">Kelola Keuangan dengan</span> <br /> Cerdas Bersama Financial Tracker </p>
